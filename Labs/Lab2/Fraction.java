...
class Fraction {
  ...
  public void changeNumerator(int numerator) { // DO NOT CHANGE THIS SIGNATURE!
    ...
    this.numerator = numerator;									// Assign method parameter value to current fraction object.
  }
  ...
  public int fracs() {                         // DO NOT CHANGE THIS SIGNATURE!
    // Fix the bug that prevents this method from working correctly.	
	return numberOfFractions;									// Define numberOfFractions as static variable.
  }
 ...
 //   return 1;
  ...
  public static void main(String[] argv) {
    ...
    Fraction sumOfThree = new Fraction(f0.numerator*f2.denominator + f1.numerator*f2.denominator + f2.numerator,f0.denominator*f1.denominator*f2.denominator);	// Sum of f0, f1, and f2.
